...
const API_KEY = "&appid=2b6549afb5487cb91215fd0408fc4c76";
...
const getWeather = () => {
	...
	axios
		...
		.then(res => {
			...
			const status = Object.assign({}, ...res.data.weather); //Mocno zakombinowane podejście równie dobrze można było zapisać res.data.weather[0].weather
